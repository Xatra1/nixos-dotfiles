# Workaround to fix KDE Plasma's massive performance regression on NixOS
# Stolen from https://github.com/NixOS/nixpkgs/issues/126590#issuecomment-3694376547
# with a revision from the following comment
{
  nixpkgs.overlays = [
    (final: prev: {
